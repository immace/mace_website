...
document.addEventListener('DOMContentLoaded', () => {
  ...
  class TextScramble {
    constructor(el) {
      this.el = el;
      this.chars = 'абвгдеёжзийклмнопрстуфхцчшщъыьэюяABCDEFGHIJKLMNOPQRSTUVWXYZ';
  ...
  function changeRole() {
    ...
    nextSpan.textContent = roles[nextIndex];
    nextSpan.classList.add('slide-in');
    roleWrapper.appendChild(nextSpan);
  ...
  // Portfolio rendering omitted for brevity, assuming unchanged from original
